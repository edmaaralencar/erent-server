...
let sut: FetchRentalsByUserIdUseCase

describe('Fetch Rentals By User Id Use Case', () => {
  beforeEach(async () => {
    rentalsRepository = new InMemoryRentalsRepository()
    usersRepository = new InMemoryUsersRepository()
    propertiesRepository = new InMemoryPropertiesRepository()
    sut = new FetchRentalsByUserIdUseCase(rentalsRepository)
  })

  it('should be able to get a rental by user id', async () => {
